...
const HT_TextureSetImportEditor = preload("texture_editor/set_editor/texture_set_import_editor.gd")
...
const HT_TextureSetImportEditorScene = preload("texture_editor/set_editor/texture_set_import_editor.tscn")
